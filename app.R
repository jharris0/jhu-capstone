...
letter-spacing: -2px;
                ...
                fluidRow(
                        box(
                                ...
                                sequence.",
                                br(),br(),
                                "Code for the algorithm and this web app are available at github.com/jharris0.",
                                br(),br(),
                ...
                conditionalPanel(
                        ...
                        fluidRow(
                                box(
                                        width  = 5,
                                        collapsible = TRUE,
                                        tags$p("The following table shows the possible options generated by the algorithm, ranked by adjusted probability."),
